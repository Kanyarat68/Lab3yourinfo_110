...
import 'package:yourinfo/pangs/food.dart';
import 'package:yourinfo/pangs/model.dart';
import 'package:yourinfo/pangs/year_std.dart';

import 'model.dart';

class Inputwidgets extends StatefulWidget {
  const Inputwidgets({Key? key, String? title}) : super(key: key);
